...
public sealed class CommandRepository : BaseRepository<ITelegramContext, CommandRepository>, ICommandRepository
{
    public CommandRepository(ITelegramContext db, ILogger<CommandRepository> logger) : base(db, logger)
    {
    }
